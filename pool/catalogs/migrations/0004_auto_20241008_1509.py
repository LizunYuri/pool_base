# Generated by Django 3.2 on 2024-10-08 12:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('catalogs', '0003_auto_20241008_1457'),
    ]

    operations = [
        migrations.RenameModel(
            old_name='FinishingMaterials',
            new_name='FinishingMaterialsModel',
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_zaclad', models.CharField(blank=True, choices=[('scimmer', 'Скиммер'), ('forsunka', 'Возвратная фрсунка'), ('sliv', 'Донный слив'), ('doliv', 'Долив воды'), ('polusos', 'Пылесос')], help_text='Выбрать подходящее', max_length=20, null=True, verbose_name='Тип закладного элмента')),
                ('type_materials', models.CharField(blank=True, choices=[('abs', 'ABS пластик'), ('aisi', 'AISI-316 нержавеющий металл')], default='abs', help_text='Пластик или нерж', max_length=20, null=True, verbose_name='Категория материала')),
